...
import { BookOpen, Plus, FileText, Presentation, Settings, User, MessageCircle, MessageSquare } from 'lucide-react';
            ...
            <div className="glass-panel" style={{ padding: '2rem', backgroundColor: 'white' }}>
                ...
                {activeTab === 'settings' && (
                    <div className="animate-fade-in" style={{ maxWidth: '800px' }}>
                        <h3 style={{ fontSize: '1.25rem', color: 'var(--color-primary)', marginBottom: '2rem' }}>إعدادات الملف الشخصي</h3>
                        <div style={{ display: 'flex', gap: '2rem', alignItems: 'start' }}>
                            ...
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                <div>
                                    ...
                                    <input type="text" readOnly value={profile?.full_name || ''} style={{ width: '100%', padding: '0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', backgroundColor: 'var(--color-surface)' }} />
                                </div>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>الرتبة العلمية</label>
                                        <input type="text" readOnly value={profile?.rank || ''} style={{ width: '100%', padding: '0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', backgroundColor: 'var(--color-surface)' }} />
                                    </div>
                                    <div>
                                        <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>القسم</label>
                                        <input type="text" readOnly value={profile?.department || ''} style={{ width: '100%', padding: '0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', backgroundColor: 'var(--color-surface)' }} />
                                    </div>
                                </div>
                            </div>
                        </div>
